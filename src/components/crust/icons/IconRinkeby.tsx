...
const IconRinkeby = (props: IconProps) => {
  const { style } = useCrustIconProps(props, {
    height: 42,
    color: '#8247E5',
    ratio: 270.3 / 432
  });
  return (
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 270.3 432" style={style}>
      <g transform="translate(371.99 247)" id="Vector">
        <linearGradient
          ...
          x2="-1449.636"
          y2="-272.782"
          gradientTransform="matrix(0 32 -32 0 -8965.865 46573.355)"
        >
          <stop offset="0" stopColor="#a7d387" />
          <stop offset="1" stopColor="#10773e" />
        </linearGradient>
        <path
          id="path0_fill"
          style={{ ...style, fill: 'url(#path0_fill_1_)' }}
...
export default React.memo(IconRinkeby);
